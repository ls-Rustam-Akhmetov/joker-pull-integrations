...
import ru.example.instruments.config.BloombergConfig;
import ru.example.instruments.mapper.ActionMapper;
import ru.example.instruments.model.*;
import ru.example.instruments.out.kafka.KafkaProducer;
import ru.example.instruments.out.ws.BloombergAdapter;
