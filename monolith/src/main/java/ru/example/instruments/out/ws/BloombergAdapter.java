package ru.example.instruments.out.ws;
...
import ru.example.instruments.out.ws.helper.BloombergRequestHelper;
import ru.example.instruments.out.ws.helper.ResponseParser;
