...
import ru.example.bloomberg.model.exception.InternalServerErrorException;
...
import static ru.example.bloomberg.model.Constant.InstrumentFields.TICKER;
...
import static ru.example.bloomberg.util.CurrencyHelper.isCurrency;
